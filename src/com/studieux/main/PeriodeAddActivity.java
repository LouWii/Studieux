...
public class PeriodeAddActivity extends Activity {
	...
	{
		RelativeLayout rl = (RelativeLayout) findViewById(R.id.addPeriodeLayout);
		rl.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				PeriodeAddActivity.this.hideSoftKeyboard();
	...
	private void hideSoftKeyboard(){
		if(getCurrentFocus()!=null && getCurrentFocus() instanceof EditText){
			...
			imm.hideSoftInputFromWindow(this.nom.getWindowToken(), 0);
		}
	}
